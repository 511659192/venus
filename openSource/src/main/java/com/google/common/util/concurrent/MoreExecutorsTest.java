...
public class MoreExecutorsTest extends JSR166TestCase {
    ...
    public static void main(String[] args) throws Exception {
        new MoreExecutorsTest().testDirectExecutorServiceServiceInThreadExecution();
    }
    ...
    /** Wait for the given thread to reach the {@link Thread.State#TIMED_WAITING} thread state. */

...
local function loadngx(path)
    ngx.print(":loadngx<br>")
    local vars = VAR_PHASES[phase()]
    local file, location = path, vars and var.template_location
    ngx.print(type(location) .. ":location<br>")
    ngx.print(type(file) .. ":file<br>")
...
do
    ...
    ngx.print(_VERSION .. "_VERSION<br/>")
